...
OUTPUT_FILE = r'c:\ex1\microservices-demo\lstm_autoscaler\outputs\live_comparison_results\lstm_live_dataset.csv'
USERS_LOG_FILE = r'c:\ex1\microservices-demo\lstm_autoscaler\outputs\live_comparison_results\lstm_users_log.json'
